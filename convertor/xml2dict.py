...
"""
## \file ../src/utils/convertor/xml2dict.py
# -*- coding: utf-8 -*-
...
def _make_dict(tag, value):
    """Generate a new dict with tag and value
       If tag is like '{http://cs.StringFormattersu.edu/csc867/myscheduler}patients',
       split it first to: http://cs.StringFormattersu.edu/csc867/myscheduler, patients
    """
    tag_values = value
